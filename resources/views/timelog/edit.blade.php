                    ...
                    <form id="timeLogForm">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('work_date') is-invalid @enderror"
                                        ...
                                        value="{{ old('work_date', $timeLog->work_date->format('Y-m-d')) }}" required>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <input type="number"
                                                ...
                                                max="10" value="{{ old('hours', $timeLog->hours) }}" required>
                                        ...
                                        <div class="col-6">
                                            <input type="number"
                                                ...
                                                max="59" value="{{ old('minutes', $timeLog->minutes) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control task-description @error('task_description') is-invalid @enderror" id="task_description"
                                name="task_description" rows="4" placeholder="Describe the task you worked on..." required>{{ old('task_description', $timeLog->task_description) }}</textarea>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#timeLogForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('timelog.update', $timeLog->id) }}',
                    type: 'POST',
                    data: $(this).serialize(),
            ...
            function updateRecentLogs(date, logs) {
                ...
                if (logs.length > 0) {
                    ...
                    logs.forEach(function(log) {
                        const isCurrentLog = log.id == {{ $timeLog->id }};
                        const rowClass = isCurrentLog ? 'bg-light' : '';
                        const editButton = isCurrentLog ?
                        ...
                        html += `
                    <div class="time-log-item ${rowClass}">
